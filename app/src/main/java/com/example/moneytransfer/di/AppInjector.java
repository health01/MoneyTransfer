...
public class AppInjector {
    ...
    public static void init(MoneyTransferApp roneApp) {
    ...
    //TODO:Fragment的部分，在handleActivity(activity)會檢查Activity是否為FragmentActivity，若是的話註冊其下Fragment的生命週期callback，並在onFragmentPreAttached檢查Fragment是否為Injectable以執行inject。
